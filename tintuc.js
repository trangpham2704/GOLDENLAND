   function m2_t2() {
       document.getElementById("noidung").innerHTML =
           ...
           '<div class="row g-0">' +
           '<div class="col-md-4">' +
           ' <img src="https://cafefcdn.com/203337114487263232/2023/12/10/bds-1538-1702250612869-17022506129741421964734.jpeg" class="img-fluid rounded-start" alt="..." style="margin:20px;"> ' +
           '</div>' +
           '<div class="col-md-8">' +
           '<div class="card-body">' +
           ...
           '<div class="row g-0">' +
           '<div class="col-md-4">' +
           ' <img src="https://cdn-i.vtcnews.vn/resize/th/upload/2023/12/04/nha-9-15290047.jpeg" class="img-fluid rounded-start" alt="..." style="margin:20px;"> ' +
           '</div>' +
           '<div class="col-md-8">' +
           '<div class="card-body">' +
           ...
           '<p class="card-text" style="text-align: justify; font-size: 18px;margin:20px; ">Đó là nhận định của nhiều chuyên gia khi dự báo về thị trường bất động sản năm 2024 sắp tới.<br><small  style="font-size: 13px;">17-12-2023 </small><br> <br> <a href="" style="color: goldenrod; margin-left:600px;">XEM CHI TIẾT</a> </center></p>' +
           '</div>' +
           '</div>' +
           '</div>' +
           '</div>' +
           ...
           '<div class="row g-0">' +
           '<div class="col-md-4">' +
           ' <img src="https://cafefcdn.com/thumb_w/640/203337114487263232/2023/12/5/avatar1701741599504-1701741599763638189614.jpg" class="img-fluid rounded-start" alt="..." style="margin:20px;"> ' +
           '</div>' +
           '<div class="col-md-8">' +
           '<div class="card-body">' +
           ...
           '<p class="card-text" style="text-align: justify; font-size: 18px;margin:20px; ">Theo ông Nguyễn Văn Đính, Chủ tịch Hội môi giới bất động sản Việt Nam, chắc chắn sau khi vượt qua “đại nạn” này, các đối tượng sẽ hoạt động một cách cẩn trọng hơn, biết “liệu cơm gắp mắm”, “tự lượng sức mình” .<br><small  style="font-size: 13px;">14/12/2023</small><br> <br> <a href="" style="color: goldenrod; margin-left:600px;">XEM CHI TIẾT</a></p>' +
           '</div>' +
           '</div>' +
           '</div>' +
           '</div>' +
           ...
           '<div class="row g-0">' +
           '<div class="col-md-4">' +
           ' <img src="https://media-vov.emitech.vn/sites/default/files/styles/large/public/2023-11/10_18_0.jpg" class="img-fluid rounded-start" alt="..." style="margin:20px;"> ' +
           '</div>' +
           '<div class="col-md-8">' +
           '<div class="card-body">' +
